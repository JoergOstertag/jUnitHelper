...
import name.ostertag.test.utils.FileHelper;
import name.ostertag.test.utils.JosExceptionUtils;
import name.ostertag.test.utils.JsonHelper;
...
public class AbstractTest {
	 ...
	 *
	 * @see assertExpectedResult(Object value, String filenameAddition);
	 *
	 * @param value
	 */
	...
	public void assertExpectedResult(Object value, String filenameAddition) {
		...
		try {
			...
			LOGGER.error("ERROR converting Object-Value into String representation\n"
					+ JosExceptionUtils.CompactStackTrace(e));
		}
		...
		FileHelper.writeFile(filenameSeenResults, valueString);

		// Get the Expected Result
		String expectedResult = FileHelper.readFile(filenameExpectedResults);
		...
		if ((null != expectedResult) && expectedResult.equals(valueString)) {
			...
			FileHelper.writeFile(filenameErrorResults, valueString);
	...
	void beforeEach(TestInfo testInfo) {
		...
		testMethodEclipseDebugString = JosExceptionUtils.getEclipseDebugString(testMethod);
